...
//		return n1 / n2;
	...
	static double[] calcArrayTotal(int... nums) {
		...
		double avrg = (double)total / nums.length;
		return new double[] {total, avrg};
	}
	...
	public static void main(String[] args) {
        ...
        {57, 89, 78, 91, 93, 47}
        */
		double[] calc = calcArrayTotal(57, 89, 78, 91, 93, 47);
		System.out.printf("합계: %.0f점\t평균: %.2f점\n", calc[0], calc[1]);
